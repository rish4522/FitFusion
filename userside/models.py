...
class User_master(models.Model):
    ...
    photo = models.ImageField(null=True,validators=[FileExtensionValidator(allowed_extensions=['jpg','png'])],help_text="Image File of User <br> Must of be .jpg or .png <br> Maximum Size 1MB",upload_to='uploads/')
